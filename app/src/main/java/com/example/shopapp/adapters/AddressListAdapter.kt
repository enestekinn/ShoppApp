...
open class AddressListAdapter (
    ...
    fun notifyEditItem(activity : Activity , position: Int) {
        ...
        intent.putExtra(Constans.EXTRA_ADDRESS_DETAILS,list[position])
        activity.startActivityForResult(intent,Constans.ADD_ADDRESS_REQUEST_CODE)
        ...
        if (holder is MyViewHolder) {
            ...
            if (selectAddress) {
                holder.itemView.setOnClickListener {
                    ...
                    intent.putExtra(Constans.EXTRA_SELECTED_ADDRESS, model)
