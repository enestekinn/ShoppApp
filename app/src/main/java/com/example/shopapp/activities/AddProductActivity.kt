...
class AddProductActivity : BaseActivity() , View.OnClickListener {
   ...
   private var  mSelectedImageFileURI : Uri? = null
    ...
    private fun uploadProductImage() {
        ...
        FirestoreClass().uploadImageToCloudStorage(this,mSelectedImageFileURI,Constans.PRODUCT_IMAGE)
    ...
    fun imageUploadSuccess(imageURL : String) {
     ...
     //   showErrorSnackBar("Product is uploaded successfully . ${imageURL}",false)
    ...
    private  fun uploadProductDetails() {
        val username = this.getSharedPreferences(
            Constans.MYSHOPPAL_PREGERENCES,
            Context.MODE_PRIVATE)
            .getString(Constans.LOGGED_IN_USERNAME,"")
    ...
    private fun validateProductDetails() : Boolean {
        return  when {
            ...
            TextUtils.isEmpty(et_product_title.text.toString().trim {  it <= ' ' } )-> {
                showErrorSnackBar(resources.getString(R.string.et_hint_product_price),true)
                false
            }
