...
class MyOrderDetailsActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var myOrderDetails: Order = Order() // empty object
        if (intent.hasExtra(Constans.EXTRA_MY_ORDER_DETAILS)) {
            myOrderDetails = intent.getParcelableExtra(Constans.EXTRA_MY_ORDER_DETAILS)!!
        }
...
tv_order_details_date.text = orderDetails.title

    val dateFormat = "dd MMM yyyy HH:m"
